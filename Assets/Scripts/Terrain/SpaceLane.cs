...
/// <summary>
/// 우주 레인 - 우주선 이동 장애물 (좌→우) + 암석/안테나 고정 장애물
/// </summary>
public class SpaceLane : BaseLane
{
    ...
    [SerializeField] private GameObject[] fixedObstaclePrefabs;  // 암석, 안테나
    ...
    [SerializeField] private GameObject[] movingObstaclePrefabs;  // 우주선 종류별
    ...
    private void SpawnMovingObstacle()
    {
        ...
        float speed = (speeds != null && typeIndex < speeds.Length) ? speeds[typeIndex] : 5f;
